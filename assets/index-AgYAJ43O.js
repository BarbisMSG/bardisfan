 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oP=5*60,lP=Yg("authIdTokenMaxAge")||oP;let mp=null;const aP=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>lP)return;const i=n==null?void 0:n.token;mp!==i&&(mp=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function uP(t=o_()){const e=fs(t,"auth");if(e.isInitialized())return e.getImmediate();const n=AR(t,{popupRedirectResolver:nP,persistence:[fN,tN,vy]}),r=Yg("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const o=aP(s.toString());YR(n,o,()=>o(n.currentUser)),qR(n,l=>o(l))}}const i=Kg("auth");return i&&xR(n,`http://${i}`),n}function cP(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}IR({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const s=Et("internal-error");s.customData=i,n(s)},r.type="text/javascript",r.charset="UTF-8",cP().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});sP("Browser");function dP(t){const{children:e}=t,n=uP(),r={usuario:[],estadoLogin:!1},[i,s]=C.useReducer(Y1,r),o=(c,h)=>{GR(n,c,h).then(g=>{const _=g.user;console.log(g,_),s({type:"CREAR_USUARIO",payload:_}),guardarUsuario(_),barrera(_),console.log("-------> TENES CUENTA!")}).catch(g=>{g.code,g.message})},l=(c,h)=>{KR(n,c,h).then(g=>{const _=g.user;s({type:"LOGUEAR_USUARIO",payload:_}),barrera(_)}).catch(g=>{g.code,g.message})},a=()=>{JR(n).then(()=>{s({type:"DESLOGUEAR_USUARIO",payload:null}),barrera(!1),console.log("------>> Estas deslogueado")}).catch(c=>{})},u=()=>{QR(n,c=>{console.log(c),c?(c.uid,s({type:"PERSISTENCIA_USUARIO",payload:c})):s({type:"USUARIO_NOLOGUEADO"})})},d=()=>{};return N.jsx(N.Fragment,{children:N.jsx(_l.Provider,{value:{crearUsuario:o,loginUsuario:l,desloguearUsuario:a,estoyDentro:u,estadoLogin:i.estadoLogin,escribirUsuario:d},children:e})})}function hP(){return N.jsx(N.Fragment,{children:N.jsx(JE,{children:N.jsx(dP,{children:N.jsx(rS,{children:N.jsxs(VE,{children:[N.jsx(no,{path:"/bardisfan",element:N.jsx(B1,{})}),N.jsx(no,{path:"/deslogueado",element:N.jsx(Bg,{})}),N.jsx(no,{path:"/logueado",element:N.jsx(Wg,{})})]})})})})})}ka.createRoot(document.getElementById("root")).render(N.jsx(hP,{}));
